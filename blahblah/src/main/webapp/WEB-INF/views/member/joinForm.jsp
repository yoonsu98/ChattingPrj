		...
		<div class="jumbotron">
			...
			<form>
				...
				<div class="input-group">
					<span class="input-group-addon"></span> <input id="id" name="id"
				...
				<p>
				<div class="input-group">
					<span class="input-group-addon"></span> <input id="pw" name="pw"
						type="password" class="form-control" placeholder="패스워드">
					<div class="check_font" id="pw_check"></div>
				</div>
				</p>
				<p>
				<div class="input-group">
					<span class="input-group-addon"></span> <input id="nickname"
				...
				<div class="input-group">
					<span class="input-group-addon"></span> <input id="email"
						name="email" type="email" class="form-control" placeholder="이메일">
					<div class="check_font" id="email_check"></div>
				</div>
				</p>
				<p>
				<div class="input-group">
					<span class="input-group-addon"></span> <input id="phone"
						name="phone" type="text" class="form-control" placeholder="전화번호">
					<div class="check_font" id="phone_check"></div>
				</div>
				</p>
				<input id="button" type="button" class="btn btn-default"
					onClick="fn_joinFn()" value="가입하기" />
			</form>
		</div>
	</div>
	<!-- footer -->
